                  ...
                  {projects.slice(0, 6).map((proj) => (
                    <div key={proj._id} className="dash-project-card">
                      ...
                      <div className="dash-proj-client">
                        ...
                        <span>Client: <strong>{proj.client?.fullName || "Melkamu Gatew"}</strong></span>
              ...
              <div className="form-group">
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                  {(formData.milestones || createDefaultMilestones()).map((milestone, index) => (
                    <div key={index} style={{ border: "1px solid #e2e8f0", borderRadius: "10px", padding: "12px", background: "white" }}>
